...
public class UpdaterService extends IntentService {
    ...
    public static final String EXTRA_ERROR_MSG = "com.example.xyzreader.intent.extra.ERROR_MSG";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (ni == null || !ni.isConnected()) {
            errorMsgCode = R.string.error_msg_no_internet;
            ...
            try {
                ...
                errorMsgCode = R.string.error_msg_parsing_feed;
                Log.e(TAG, "Error updating content.", e);
            }
        }

        final Intent intentResponse = new Intent(BROADCAST_ACTION_STATE_CHANGE).putExtra(EXTRA_REFRESHING, false);
        if (errorMsgCode != -1) intentResponse.putExtra(EXTRA_ERROR_MSG, errorMsgCode);
